...
let Pswd = "Aryapro";
const proxyIPs = ["103.93.59.85"]; //ts.hpc.tw edgetunnel.anycast.eu.org bestproxy.onecf.eu.org cdn-all.xn--b6gac.eu.org cdn.xn--b6gac.eu.org proxy.xxxxxxxx.tk
let cn_hostnames = [''];
...
<div class="container">
  ...
  <div id="Date">..., ...-...-...</div>
	...
	<br />
	<pre class="animation fw-bold text-danger"><i style="height:50px;">SELAMAT DATANG SAYANGKU<br/>GRATIS TROJAN CLOUDFLARE</i></pre>
</div>
      <p>${noteshow}</p>
      <table>
				<tbody>
