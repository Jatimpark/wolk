...
async function getAllConfigVless(env, hostName, listProxy) {
  const listProxyElements = listProxy
    .map(({ proxyIP, proxyPort, country, isp }, index) => {
      const vlessTls = `vless://${generateUUIDv4()}@bug.com:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2Fvl%3D${proxyIP}%3D${proxyPort}#(${country}) ${isp}`;
      const vlessNtls = `vless://${generateUUIDv4()}@bug.com:80?path=%2Fvl%3D${proxyIP}%3D${proxyPort}&security=none&encryption=none&host=${hostName}&fp=randomized&type=ws&sni=${hostName}#(${country}) ${isp}`;
      const trojanTls = `trojan://${generatePASSWD()}@bug.com:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2Ftr%3D${proxyIP}%3D${proxyPort}#(${country}) ${isp}`;
      const trojanNtls = `trojan://${generatePASSWD()}@bug.com:80?path=%2Ftr%3D${proxyIP}%3D${proxyPort}&security=none&encryption=none&host=${hostName}&fp=randomized&type=ws&sni=${hostName}#(${country}) ${isp}`;

      return `
        <div class="content ${index === 0 ? "active" : ""}">
          <h2>VLESS & TROJAN CLOUDFLARE</h2><br>
          <h2>NBC BLITAR INDONESIA</h2><br>
  ...
  return `
    ...
    <meta property="og:image" content="https://raw.githubusercontent.com/Jatimpark/wolk/refs/heads/main/bulan.jpg"> <!-- Ganti dengan URL gambar yang sesuai -->
    <meta property="og:url" content="https://raw.githubusercontent.com/Jatimpark/wolk/refs/heads/main/bulan.jpg">
    ...
    <meta name="twitter:image" content="https://raw.githubusercontent.com/Jatimpark/wolk/refs/heads/main/bulan.jpg"> <!-- Ganti dengan URL gambar yang sesuai -->
        <style>
  html, body {
    height: 100%;
    width: 100%;
  ...
  body {
    display: flex;
    background: url('https://raw.githubusercontent.com/Jatimpark/wolk/refs/heads/main/bulan.jpg') no-repeat center center fixed;
  ...
  .tabs {
    ...
    overflow-y: auto;
    overflow-x: hidden;
    border-right: 2px solid #00FF00; /* Warna ijo */
  ...
  .author-link {
    ...
    font-weight: bold;
    font-style: italic;
    color: #00FF00; /* Warna ijo */
    font-size: 12px;
    text-decoration: none;
    z-index: 10;
  }
  .author-link:hover {
    color: #00FF00; /* Kuning ijo */
    ...
    .config-block h4 { font-size: 20px; }
      ...
      <body>
        <div class="popup">
          ...
          <a href="https://t.me/Arya77pro" class="watermark" target="_blank">@Arya77pro</a>
        </div>
        <script>
          function filterTabs() {
